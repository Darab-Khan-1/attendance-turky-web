...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title>Fleet Fusion | Login</title>
			...
			<div class="login login-4 login-signin-on d-flex flex-row-fluid" id="kt_login">
				<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('assets/media/bg/bg-3.jpg');">
					<div class="login-form text-center p-7 position-relative ">
						<!--begin::Login Header-->
						{{-- <a href="{{ url('booking') }}" class="btn btn-lg text-dark" style="font-size: large;width: 250px;position: fixed;right: 100px;background: #ffc500;top: 50px;border-radius: 30px;box-shadow: 0px 0px 10px 10px #dadada;" ><b>Book Now</b></a> --}}
						@if (session('success'))
					...
					@endif
						<div class="d-flex flex-center">
							<a href="#">
								<img src="{{ asset('assets/media/logos/logo.png') }}" class="max-h-200px" alt="" style="border-radius:20px;" />
							</a>
						</div>
						<!--end::Login Header-->
						...
						<div class="login-signin">
							...
							<form class="form" id="kt_login_signin_form">
								...
								<button id="kt_login_signin_submit" class="btn font-weight-bold px-9 py-4 my-3 mx-4 text-white btn-primary" >Sign In</button>
                                &nbsp;<div class="spinner-border" role="status" id="processing"
                                        style="display:none">
							</form>
							{{-- <div class="mt-10">
